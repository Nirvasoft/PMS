...
async function main() {
  ...
  const PERMISSIONS = [
    ...
    { code: 'ar.read', name: 'View Accounts Receivable', module: 'ar', action: 'read' },
    { code: 'ar.write', name: 'Manage Accounts Receivable', module: 'ar', action: 'write' },
    { code: 'ap.read', name: 'View Accounts Payable', module: 'ap', action: 'read' },
    { code: 'ap.write', name: 'Manage Accounts Payable', module: 'ap', action: 'write' },
    { code: 'finance.read', name: 'View Finance', module: 'finance', action: 'read' },
    { code: 'finance.write', name: 'Manage Finance', module: 'finance', action: 'write' },
    { code: 'maintenance.read', name: 'View Maintenance', module: 'maintenance', action: 'read' },
    { code: 'maintenance.write', name: 'Manage Maintenance', module: 'maintenance', action: 'write' },
    { code: 'facility.read', name: 'View Facility', module: 'facility', action: 'read' },
    { code: 'facility.write', name: 'Manage Facility', module: 'facility', action: 'write' },
    { code: 'inventory.read', name: 'View Inventory', module: 'inventory', action: 'read' },
    { code: 'inventory.write', name: 'Manage Inventory', module: 'inventory', action: 'write' },
    { code: 'housekeeping.read', name: 'View Housekeeping', module: 'housekeeping', action: 'read' },
    { code: 'housekeeping.write', name: 'Manage Housekeeping', module: 'housekeeping', action: 'write' },
    { code: 'security.read', name: 'View Security', module: 'security', action: 'read' },
    { code: 'security.write', name: 'Manage Security', module: 'security', action: 'write' },
    { code: 'mall.read', name: 'View Shopping Mall', module: 'mall', action: 'read' },
    { code: 'mall.write', name: 'Manage Shopping Mall', module: 'mall', action: 'write' },
    { code: 'community.read', name: 'View Community', module: 'community', action: 'read' },
    { code: 'community.write', name: 'Manage Community', module: 'community', action: 'write' },
    { code: 'condo.read', name: 'View Condo', module: 'condo', action: 'read' },
    { code: 'condo.write', name: 'Manage Condo', module: 'condo', action: 'write' },
    ...
    { code: 'developer.read', name: 'View Developer Tools', module: 'developer', action: 'read' },
    { code: 'developer.write', name: 'Manage Developer Tools', module: 'developer', action: 'write' },
  ];
