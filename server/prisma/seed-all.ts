...
async function main() {
  ...
  const PERMISSIONS = [
    ...
    { code: 'billing-dashboard.read', name: 'View Billing Dashboard', module: 'billing-dashboard', action: 'read' },
    { code: 'billing-dashboard.write', name: 'Manage Billing Dashboard', module: 'billing-dashboard', action: 'write' },
    { code: 'billing-invoices.read', name: 'View Invoices', module: 'billing-invoices', action: 'read' },
    { code: 'billing-invoices.write', name: 'Manage Invoices', module: 'billing-invoices', action: 'write' },
    { code: 'billing-schedules.read', name: 'View Schedules', module: 'billing-schedules', action: 'read' },
    { code: 'billing-schedules.write', name: 'Manage Schedules', module: 'billing-schedules', action: 'write' },
    { code: 'billing-charge-types.read', name: 'View Charge Types', module: 'billing-charge-types', action: 'read' },
    { code: 'billing-charge-types.write', name: 'Manage Charge Types', module: 'billing-charge-types', action: 'write' },
    { code: 'currency-rate.read', name: 'View Currency Rates', module: 'currency-rate', action: 'read' },
    { code: 'currency-rate.create', name: 'Create Currency Rates', module: 'currency-rate', action: 'create' },
    { code: 'currency-rate.update', name: 'Update Currency Rates', module: 'currency-rate', action: 'update' },
    { code: 'currency-rate.delete', name: 'Delete Currency Rates', module: 'currency-rate', action: 'delete' },
    { code: 'billing-settings.read', name: 'View Billing Settings', module: 'billing-settings', action: 'read' },
    { code: 'billing-settings.write', name: 'Manage Billing Settings', module: 'billing-settings', action: 'write' },
    ...
    { code: 'dashboard.view', name: 'View Dashboard', module: 'dashboard', action: 'read' },
    { code: 'reports-executive.read', name: 'View Executive Dashboard', module: 'reports-executive', action: 'read' },
    { code: 'reports-executive.write', name: 'Manage Executive Dashboard', module: 'reports-executive', action: 'write' },
    { code: 'reports-bi.read', name: 'View BI Reports', module: 'reports-bi', action: 'read' },
    { code: 'reports-bi.write', name: 'Manage BI Reports', module: 'reports-bi', action: 'write' },
    { code: 'reports-anomalies.read', name: 'View Anomaly Dashboard', module: 'reports-anomalies', action: 'read' },
    { code: 'reports-anomalies.write', name: 'Manage Anomaly Dashboard', module: 'reports-anomalies', action: 'write' },
    { code: 'reports-list.read', name: 'View Reports', module: 'reports-list', action: 'read' },
    { code: 'reports-list.write', name: 'Manage Reports', module: 'reports-list', action: 'write' },
    { code: 'settings-security.read', name: 'View Security Settings', module: 'settings-security', action: 'read' },
    { code: 'settings-security.write', name: 'Manage Security Settings', module: 'settings-security', action: 'write' },
    { code: 'settings-notifications.read', name: 'View Notification Prefs', module: 'settings-notifications', action: 'read' },
    { code: 'settings-notifications.write', name: 'Manage Notification Prefs', module: 'settings-notifications', action: 'write' },
    { code: 'settings-profile.read', name: 'View My Profile', module: 'settings-profile', action: 'read' },
    { code: 'settings-profile.write', name: 'Manage My Profile', module: 'settings-profile', action: 'write' },
    ...
    { code: 'workflows-tasks.read', name: 'View My Tasks', module: 'workflows-tasks', action: 'read' },
    { code: 'workflows-tasks.write', name: 'Manage My Tasks', module: 'workflows-tasks', action: 'write' },
    { code: 'workflows-engine.read', name: 'View Workflow Engine', module: 'workflows-engine', action: 'read' },
    { code: 'workflows-engine.write', name: 'Manage Workflow Engine', module: 'workflows-engine', action: 'write' },
    { code: 'crm-leads.read', name: 'View Lead Pipeline', module: 'crm-leads', action: 'read' },
    { code: 'crm-leads.write', name: 'Manage Lead Pipeline', module: 'crm-leads', action: 'write' },
    { code: 'crm-campaigns.read', name: 'View Campaigns', module: 'crm-campaigns', action: 'read' },
    { code: 'crm-campaigns.write', name: 'Manage Campaigns', module: 'crm-campaigns', action: 'write' },
    { code: 'parking-overview.read', name: 'View Parking Overview', module: 'parking-overview', action: 'read' },
    { code: 'parking-overview.write', name: 'Manage Parking Overview', module: 'parking-overview', action: 'write' },
    { code: 'parking-allocations.read', name: 'View Allocations', module: 'parking-allocations', action: 'read' },
    { code: 'parking-allocations.write', name: 'Manage Allocations', module: 'parking-allocations', action: 'write' },
    { code: 'parking-visitors.read', name: 'View Visitor Parking', module: 'parking-visitors', action: 'read' },
    { code: 'parking-visitors.write', name: 'Manage Visitor Parking', module: 'parking-visitors', action: 'write' },
    { code: 'parking-gate-logs.read', name: 'View Gate Logs', module: 'parking-gate-logs', action: 'read' },
    { code: 'parking-gate-logs.write', name: 'Manage Gate Logs', module: 'parking-gate-logs', action: 'write' },
    { code: 'parking-vehicles.read', name: 'View Vehicle Registry', module: 'parking-vehicles', action: 'read' },
    { code: 'parking-vehicles.write', name: 'Manage Vehicle Registry', module: 'parking-vehicles', action: 'write' },
    { code: 'company.read', name: 'View Company', module: 'company', action: 'read' },
    { code: 'company.manage', name: 'Manage Company', module: 'company', action: 'manage' },
    { code: 'ar-receipts.read', name: 'View Receipts', module: 'ar-receipts', action: 'read' },
    { code: 'ar-receipts.write', name: 'Manage Receipts', module: 'ar-receipts', action: 'write' },
    { code: 'ar-aging.read', name: 'View Aging Report', module: 'ar-aging', action: 'read' },
    { code: 'ar-aging.write', name: 'Manage Aging Report', module: 'ar-aging', action: 'write' },
    { code: 'ar-collections.read', name: 'View Collections', module: 'ar-collections', action: 'read' },
    { code: 'ar-collections.write', name: 'Manage Collections', module: 'ar-collections', action: 'write' },
    { code: 'ar-refunds.read', name: 'View Refunds', module: 'ar-refunds', action: 'read' },
    { code: 'ar-refunds.write', name: 'Manage Refunds', module: 'ar-refunds', action: 'write' },
    { code: 'ar-statements.read', name: 'View Statements', module: 'ar-statements', action: 'read' },
    { code: 'ar-statements.write', name: 'Manage Statements', module: 'ar-statements', action: 'write' },
    { code: 'ar-credits.read', name: 'View Tenant Credits', module: 'ar-credits', action: 'read' },
    { code: 'ar-credits.write', name: 'Manage Tenant Credits', module: 'ar-credits', action: 'write' },
    { code: 'ap-invoices.read', name: 'View AP Invoices', module: 'ap-invoices', action: 'read' },
    { code: 'ap-invoices.write', name: 'Manage AP Invoices', module: 'ap-invoices', action: 'write' },
    { code: 'ap-vouchers.read', name: 'View Payment Vouchers', module: 'ap-vouchers', action: 'read' },
    { code: 'ap-vouchers.write', name: 'Manage Payment Vouchers', module: 'ap-vouchers', action: 'write' },
    { code: 'ap-expenses.read', name: 'View Expenses', module: 'ap-expenses', action: 'read' },
    { code: 'ap-expenses.write', name: 'Manage Expenses', module: 'ap-expenses', action: 'write' },
    { code: 'finance-coa.read', name: 'View Chart of Accounts', module: 'finance-coa', action: 'read' },
    { code: 'finance-coa.write', name: 'Manage Chart of Accounts', module: 'finance-coa', action: 'write' },
    { code: 'finance-journal.read', name: 'View Journal Entries', module: 'finance-journal', action: 'read' },
    { code: 'finance-journal.write', name: 'Manage Journal Entries', module: 'finance-journal', action: 'write' },
    { code: 'finance-fiscal-periods.read', name: 'View Fiscal Periods', module: 'finance-fiscal-periods', action: 'read' },
    { code: 'finance-fiscal-periods.write', name: 'Manage Fiscal Periods', module: 'finance-fiscal-periods', action: 'write' },
    { code: 'finance-trial-balance.read', name: 'View Trial Balance', module: 'finance-trial-balance', action: 'read' },
    { code: 'finance-trial-balance.write', name: 'Manage Trial Balance', module: 'finance-trial-balance', action: 'write' },
    { code: 'finance-pnl.read', name: 'View Profit & Loss', module: 'finance-pnl', action: 'read' },
    { code: 'finance-pnl.write', name: 'Manage Profit & Loss', module: 'finance-pnl', action: 'write' },
    { code: 'finance-balance-sheet.read', name: 'View Balance Sheet', module: 'finance-balance-sheet', action: 'read' },
    { code: 'finance-balance-sheet.write', name: 'Manage Balance Sheet', module: 'finance-balance-sheet', action: 'write' },
    { code: 'finance-cash-flow.read', name: 'View Cash Flow', module: 'finance-cash-flow', action: 'read' },
    { code: 'finance-cash-flow.write', name: 'Manage Cash Flow', module: 'finance-cash-flow', action: 'write' },
    { code: 'finance-budgets.read', name: 'View Budgets', module: 'finance-budgets', action: 'read' },
    { code: 'finance-budgets.write', name: 'Manage Budgets', module: 'finance-budgets', action: 'write' },
    { code: 'finance-assets.read', name: 'View Fixed Assets', module: 'finance-assets', action: 'read' },
    { code: 'finance-assets.write', name: 'Manage Fixed Assets', module: 'finance-assets', action: 'write' },
    { code: 'finance-banking.read', name: 'View Banking', module: 'finance-banking', action: 'read' },
    { code: 'finance-banking.write', name: 'Manage Banking', module: 'finance-banking', action: 'write' },
    { code: 'finance-gateway.read', name: 'View Gateway Payments', module: 'finance-gateway', action: 'read' },
    { code: 'finance-gateway.write', name: 'Manage Gateway Payments', module: 'finance-gateway', action: 'write' },
    { code: 'maintenance-dashboard.read', name: 'View Maintenance Dashboard', module: 'maintenance-dashboard', action: 'read' },
    { code: 'maintenance-dashboard.write', name: 'Manage Maintenance Dashboard', module: 'maintenance-dashboard', action: 'write' },
    { code: 'maintenance-tickets.read', name: 'View Tickets', module: 'maintenance-tickets', action: 'read' },
    { code: 'maintenance-tickets.write', name: 'Manage Tickets', module: 'maintenance-tickets', action: 'write' },
    { code: 'maintenance-technicians.read', name: 'View Technician Schedule', module: 'maintenance-technicians', action: 'read' },
    { code: 'maintenance-technicians.write', name: 'Manage Technician Schedule', module: 'maintenance-technicians', action: 'write' },
    { code: 'maintenance-sla.read', name: 'View SLA Configuration', module: 'maintenance-sla', action: 'read' },
    { code: 'maintenance-sla.write', name: 'Manage SLA Configuration', module: 'maintenance-sla', action: 'write' },
    { code: 'maintenance-pm.read', name: 'View PM Schedules', module: 'maintenance-pm', action: 'read' },
    { code: 'maintenance-pm.write', name: 'Manage PM Schedules', module: 'maintenance-pm', action: 'write' },
    { code: 'maintenance-pm-calendar.read', name: 'View PM Calendar', module: 'maintenance-pm-calendar', action: 'read' },
    { code: 'maintenance-pm-calendar.write', name: 'Manage PM Calendar', module: 'maintenance-pm-calendar', action: 'write' },
    { code: 'facility-assets.read', name: 'View Asset Registry', module: 'facility-assets', action: 'read' },
    { code: 'facility-assets.write', name: 'Manage Asset Registry', module: 'facility-assets', action: 'write' },
    { code: 'facility-cam.read', name: 'View CAM Costs', module: 'facility-cam', action: 'read' },
    { code: 'facility-cam.write', name: 'Manage CAM Costs', module: 'facility-cam', action: 'write' },
    { code: 'facility-schedule.read', name: 'View Booking Schedule', module: 'facility-schedule', action: 'read' },
    { code: 'facility-schedule.write', name: 'Manage Booking Schedule', module: 'facility-schedule', action: 'write' },
    { code: 'inventory-dashboard.read', name: 'View Inventory Dashboard', module: 'inventory-dashboard', action: 'read' },
    { code: 'inventory-dashboard.write', name: 'Manage Inventory Dashboard', module: 'inventory-dashboard', action: 'write' },
    { code: 'inventory-items.read', name: 'View Item Catalog', module: 'inventory-items', action: 'read' },
    { code: 'inventory-items.write', name: 'Manage Item Catalog', module: 'inventory-items', action: 'write' },
    { code: 'inventory-stock.read', name: 'View Stock Levels', module: 'inventory-stock', action: 'read' },
    { code: 'inventory-stock.write', name: 'Manage Stock Levels', module: 'inventory-stock', action: 'write' },
    { code: 'inventory-stores.read', name: 'View Stores', module: 'inventory-stores', action: 'read' },
    { code: 'inventory-stores.write', name: 'Manage Stores', module: 'inventory-stores', action: 'write' },
    { code: 'inventory-movements.read', name: 'View Movements', module: 'inventory-movements', action: 'read' },
    { code: 'inventory-movements.write', name: 'Manage Movements', module: 'inventory-movements', action: 'write' },
    { code: 'inventory-purchase-req.read', name: 'View Purchase Requisitions', module: 'inventory-purchase-req', action: 'read' },
    { code: 'inventory-purchase-req.write', name: 'Manage Purchase Requisitions', module: 'inventory-purchase-req', action: 'write' },
    { code: 'housekeeping-dashboard.read', name: 'View Housekeeping Dashboard', module: 'housekeeping-dashboard', action: 'read' },
    { code: 'housekeeping-dashboard.write', name: 'Manage Housekeeping Dashboard', module: 'housekeeping-dashboard', action: 'write' },
    { code: 'housekeeping-tasks.read', name: 'View Tasks', module: 'housekeeping-tasks', action: 'read' },
    { code: 'housekeeping-tasks.write', name: 'Manage Tasks', module: 'housekeeping-tasks', action: 'write' },
    { code: 'housekeeping-schedules.read', name: 'View Schedules', module: 'housekeeping-schedules', action: 'read' },
    { code: 'housekeeping-schedules.write', name: 'Manage Schedules', module: 'housekeeping-schedules', action: 'write' },
    { code: 'housekeeping-zones.read', name: 'View Zones', module: 'housekeeping-zones', action: 'read' },
    { code: 'housekeeping-zones.write', name: 'Manage Zones', module: 'housekeeping-zones', action: 'write' },
    { code: 'housekeeping-inspections.read', name: 'View Inspections', module: 'housekeeping-inspections', action: 'read' },
    { code: 'housekeeping-inspections.write', name: 'Manage Inspections', module: 'housekeeping-inspections', action: 'write' },
    { code: 'security-dashboard.read', name: 'View Security Dashboard', module: 'security-dashboard', action: 'read' },
    { code: 'security-dashboard.write', name: 'Manage Security Dashboard', module: 'security-dashboard', action: 'write' },
    { code: 'security-incidents.read', name: 'View Incidents', module: 'security-incidents', action: 'read' },
    { code: 'security-incidents.write', name: 'Manage Incidents', module: 'security-incidents', action: 'write' },
    { code: 'security-patrol.read', name: 'View Patrol Logs', module: 'security-patrol', action: 'read' },
    { code: 'security-patrol.write', name: 'Manage Patrol Logs', module: 'security-patrol', action: 'write' },
    { code: 'security-patrol-schedules.read', name: 'View Patrol Schedules', module: 'security-patrol-schedules', action: 'read' },
    { code: 'security-patrol-schedules.write', name: 'Manage Patrol Schedules', module: 'security-patrol-schedules', action: 'write' },
    { code: 'security-patrol-scan.read', name: 'View Patrol Scan', module: 'security-patrol-scan', action: 'read' },
    { code: 'security-patrol-scan.write', name: 'Manage Patrol Scan', module: 'security-patrol-scan', action: 'write' },
    { code: 'security-access-events.read', name: 'View Access Events', module: 'security-access-events', action: 'read' },
    { code: 'security-access-events.write', name: 'Manage Access Events', module: 'security-access-events', action: 'write' },
    { code: 'security-blacklist.read', name: 'View Visitor Blacklist', module: 'security-blacklist', action: 'read' },
    { code: 'security-blacklist.write', name: 'Manage Visitor Blacklist', module: 'security-blacklist', action: 'write' },
    { code: 'mall-dashboard.read', name: 'View Mall Dashboard', module: 'mall-dashboard', action: 'read' },
    { code: 'mall-dashboard.write', name: 'Manage Mall Dashboard', module: 'mall-dashboard', action: 'write' },
    { code: 'mall-shops.read', name: 'View Shop Directory', module: 'mall-shops', action: 'read' },
    { code: 'mall-shops.write', name: 'Manage Shop Directory', module: 'mall-shops', action: 'write' },
    { code: 'mall-gto.read', name: 'View GTO Management', module: 'mall-gto', action: 'read' },
    { code: 'mall-gto.write', name: 'Manage GTO Management', module: 'mall-gto', action: 'write' },
    { code: 'mall-cam.read', name: 'View CAM Management', module: 'mall-cam', action: 'read' },
    { code: 'mall-cam.write', name: 'Manage CAM Management', module: 'mall-cam', action: 'write' },
    { code: 'mall-events.read', name: 'View Mall Events', module: 'mall-events', action: 'read' },
    { code: 'mall-events.write', name: 'Manage Mall Events', module: 'mall-events', action: 'write' },
    { code: 'mall-footfall.read', name: 'View Footfall Analytics', module: 'mall-footfall', action: 'read' },
    { code: 'mall-footfall.write', name: 'Manage Footfall Analytics', module: 'mall-footfall', action: 'write' },
    { code: 'mall-pos.read', name: 'View POS Integration', module: 'mall-pos', action: 'read' },
    { code: 'mall-pos.write', name: 'Manage POS Integration', module: 'mall-pos', action: 'write' },
    { code: 'community-admin.read', name: 'View Community Admin', module: 'community-admin', action: 'read' },
    { code: 'community-admin.write', name: 'Manage Community Admin', module: 'community-admin', action: 'write' },
    { code: 'community-quick-actions.read', name: 'View Portal Quick Actions', module: 'community-quick-actions', action: 'read' },
    { code: 'community-quick-actions.write', name: 'Manage Portal Quick Actions', module: 'community-quick-actions', action: 'write' },
    { code: 'community-analytics.read', name: 'View Portal Analytics', module: 'community-analytics', action: 'read' },
    { code: 'community-analytics.write', name: 'Manage Portal Analytics', module: 'community-analytics', action: 'write' },
    { code: 'community-access-cards.read', name: 'View Access Cards', module: 'community-access-cards', action: 'read' },
    { code: 'community-access-cards.write', name: 'Manage Access Cards', module: 'community-access-cards', action: 'write' },
    { code: 'community-branding.read', name: 'View Portal Branding', module: 'community-branding', action: 'read' },
    { code: 'community-branding.write', name: 'Manage Portal Branding', module: 'community-branding', action: 'write' },
    { code: 'condo-meters.read', name: 'View Smart Meters', module: 'condo-meters', action: 'read' },
    { code: 'condo-meters.write', name: 'Manage Smart Meters', module: 'condo-meters', action: 'write' },
    { code: 'condo-funds.read', name: 'View Funds', module: 'condo-funds', action: 'read' },
    { code: 'condo-funds.write', name: 'Manage Funds', module: 'condo-funds', action: 'write' },
    { code: 'condo-meetings.read', name: 'View Meetings (AGM)', module: 'condo-meetings', action: 'read' },
    { code: 'condo-meetings.write', name: 'Manage Meetings (AGM)', module: 'condo-meetings', action: 'write' },
    { code: 'condo-bylaws.read', name: 'View By-Laws', module: 'condo-bylaws', action: 'read' },
    { code: 'condo-bylaws.write', name: 'Manage By-Laws', module: 'condo-bylaws', action: 'write' },
    { code: 'portal.read', name: 'View Tenant Portal', module: 'portal', action: 'read' },
    { code: 'portal.write', name: 'Manage Tenant Portal', module: 'portal', action: 'write' },
    { code: 'developer-integrations.read', name: 'View Integrations', module: 'developer-integrations', action: 'read' },
    { code: 'developer-integrations.write', name: 'Manage Integrations', module: 'developer-integrations', action: 'write' },
    { code: 'developer-webhooks.read', name: 'View Webhooks', module: 'developer-webhooks', action: 'read' },
    { code: 'developer-webhooks.write', name: 'Manage Webhooks', module: 'developer-webhooks', action: 'write' },
    { code: 'developer-api-keys.read', name: 'View API Keys', module: 'developer-api-keys', action: 'read' },
    { code: 'developer-api-keys.write', name: 'Manage API Keys', module: 'developer-api-keys', action: 'write' },
    { code: 'developer-bms.read', name: 'View BMS Devices', module: 'developer-bms', action: 'read' },
    { code: 'developer-bms.write', name: 'Manage BMS Devices', module: 'developer-bms', action: 'write' },
  ];
  ...
  const agentCodes = ['properties.read','tenants.read','tenants.create','tenants.update','leases.read','leases.create','leases.update','departments.read','positions.read','users.read','roles.read','crm-leads.read','crm-leads.write','crm-campaigns.read','crm-campaigns.write','parking-overview.read','parking-allocations.read','parking-visitors.read','parking-gate-logs.read','parking-vehicles.read','documents.read','documents.write'];
  ...
  const templateData = [
    ...
    { code: 'ticket_sla_warning', name: 'SLA Breach Warning', description: 'Sent 2 hours before a maintenance ticket SLA deadline', channels: ['in_app', 'email', 'push'], subject: '⚠️ SLA Warning: {{ticketNumber}} — {{warningType}} in {{hoursLeft}}', bodyText: '{{warningType}} for ticket {{ticketNumber}} ({{priority}}) will breach in approximately {{hoursLeft}}. Please take action now to avoid an SLA breach.', bodyPush: '⚠️ SLA warning: {{ticketNumber}} — {{hoursLeft}} left', isCritical: true, variables: [{ name: 'ticketNumber', type: 'string', required: true }, { name: 'warningType', type: 'string', required: true }, { name: 'priority', type: 'string', required: true }, { name: 'hoursLeft', type: 'string', required: true }] },
    ...
    { code: 'pm_overdue', name: 'PM Work Orders Overdue', description: 'Sent when preventive maintenance work orders become overdue', channels: ['in_app', 'push'], subject: '⚠️ {{count}} Overdue PM Work Order(s)', bodyText: '{{count}} preventive maintenance work order(s) are overdue at {{propertyName}}: {{scheduleNames}}. Please review and take action.', bodyPush: '⚠️ {{count}} PM work orders overdue at {{propertyName}}', isCritical: false, variables: [{ name: 'count', type: 'number', required: true }, { name: 'scheduleNames', type: 'string', required: true }, { name: 'propertyName', type: 'string', required: true }] },
    { code: 'facility_expiry_alert', name: 'Facility Expiry Alert', description: 'Sent when asset warranties or service contracts are expiring', channels: ['in_app', 'email', 'push'], subject: '{{level}} — {{count}} Asset(s) {{alertType}} Expiring in {{days}} Days', bodyText: '{{count}} asset(s) have {{alertType}} expiring in {{days}} days: {{assetNames}}. Please renew or take action.', bodyPush: '⚠️ {{count}} asset {{alertType}} expiring in {{days}} days', isCritical: false, variables: [{ name: 'level', type: 'string', required: true }, { name: 'days', type: 'number', required: true }, { name: 'count', type: 'number', required: true }, { name: 'alertType', type: 'string', required: true }, { name: 'assetNames', type: 'string', required: true }] },
    { code: 'stock_reorder_required', name: 'Stock Reorder Required', description: 'Sent when stock falls below reorder point', channels: ['in_app'], subject: '📦 Low Stock: {{itemName}}', bodyText: '{{itemName}} stock is at {{currentStock}}, below reorder point of {{reorderPoint}}. A purchase requisition has been auto-generated.', bodyPush: '📦 Low stock: {{itemName}} — reorder needed', isCritical: false, variables: [{ name: 'itemName', type: 'string', required: true }, { name: 'currentStock', type: 'number', required: true }, { name: 'reorderPoint', type: 'number', required: true }] },
    { code: 'security_incident_reported', name: 'Security Incident Reported', description: 'Sent when a new security incident is created', channels: ['push', 'in_app'], subject: '🚨 Security Incident: {{incidentNumber}} — {{severity}}', bodyText: 'New {{severity}} incident ({{incidentType}}): {{description}}. Location: {{location}}.', bodyPush: '🚨 {{severity}} incident: {{incidentNumber}}', isCritical: true, variables: [{ name: 'incidentNumber', type: 'string', required: true }, { name: 'incidentType', type: 'string', required: true }, { name: 'severity', type: 'string', required: true }, { name: 'location', type: 'string', required: false }, { name: 'description', type: 'string', required: false }] },
    { code: 'patrol_gap_detected', name: 'Patrol Gap Detected', description: 'Sent when a guard patrol gap exceeds 90 minutes', channels: ['push', 'in_app'], subject: '⚠️ Patrol Gap: {{guardName}} — {{gapMinutes}} min', bodyText: 'Guard {{guardName}} has a patrol gap of {{gapMinutes}} minutes. Expected interval: 90 min max.', bodyPush: '⚠️ Patrol gap: {{guardName}} — {{gapMinutes}} min', isCritical: false, variables: [{ name: 'guardName', type: 'string', required: true }, { name: 'gapMinutes', type: 'number', required: true }] },
  ];
