...
export const WIDGET_DEFINITIONS = [
  ...
  { code: 'lease_expiring_soon',   name: 'Leases Expiring (90d)',  category: 'property',    widgetType: 'data_table',  dataProvider: 'real', defaultWidth: 6, defaultHeight: 3, requiredPermissions: [] },
  // ── Finance ──
  ...
  // ── Maintenance ──
  { code: 'maintenance_open',      name: 'Open Tickets',           category: 'maintenance', widgetType: 'kpi_card',    dataProvider: 'real', defaultWidth: 3, defaultHeight: 1, requiredPermissions: [] },
  { code: 'maintenance_sla',       name: 'SLA Breaches',           category: 'maintenance', widgetType: 'kpi_card',    dataProvider: 'real', defaultWidth: 3, defaultHeight: 1, requiredPermissions: [] },
  { code: 'tickets_by_category',   name: 'Tickets by Category',    category: 'maintenance', widgetType: 'pie_chart',   dataProvider: 'real', defaultWidth: 3, defaultHeight: 2, requiredPermissions: [] },
  { code: 'maintenance_trend',     name: 'Maintenance Trend',      category: 'maintenance', widgetType: 'line_chart',  dataProvider: 'real', defaultWidth: 6, defaultHeight: 2, requiredPermissions: [] },
  // ── Activity ──
  ...
  { code: 'active_workflows',      name: 'Active Workflows',       category: 'activity',    widgetType: 'kpi_card',    dataProvider: 'real', defaultWidth: 3, defaultHeight: 1, requiredPermissions: [] },
  ...
  { code: 'documents_expiring',    name: 'Documents Expiring',     category: 'activity',    widgetType: 'kpi_card',    dataProvider: 'real', defaultWidth: 3, defaultHeight: 1, requiredPermissions: [] },
];
