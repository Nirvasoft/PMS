...
export const createLeadSchema = z.object({
  body: z.object({
    ...
    email: z.string().email('Invalid email').transform((v) => v.toLowerCase()).optional(),
    ...
    budgetMin: z.number().min(0).max(9999999999999.99, 'Budget exceeds maximum allowed value').optional(),
    budgetMax: z.number().min(0).max(9999999999999.99, 'Budget exceeds maximum allowed value').optional(),
