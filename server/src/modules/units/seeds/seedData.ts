...
export const UNIT_TYPES = [
  ...
  { code: 'room',        name: 'Room',           category: 'commercial',  description: 'General-purpose room' },
  { code: 'open_counter', name: 'Open Counter',  category: 'commercial',  description: 'Open-front service counter' },
  { code: 'booth',       name: 'Booth',          category: 'commercial',  description: 'Booth or kiosk' },
  { code: 'atm_space',   name: 'Space (For ATM)', category: 'commercial', description: 'Dedicated space for an ATM' },
  { code: 'bill_board',  name: 'Bill Board',     category: 'commercial',  description: 'Billboard advertising space' },
  { code: 'trolley',     name: 'Trolley',        category: 'commercial',  description: 'Trolley/pushcart vending space' },
  { code: 'showcase',    name: 'Showcase',       category: 'commercial',  description: 'Display showcase unit' },
  { code: 'store',       name: 'Store',          category: 'commercial',  description: 'Retail store unit' },
  { code: 'gold_counter', name: 'Gold Counter',  category: 'commercial',  description: 'Gold/jewellery counter' },
  { code: 'open_space',  name: 'Open Space',     category: 'commercial',  description: 'Open, unenclosed space' },
  { code: 'room_sale',   name: 'Room(sale)',     category: 'commercial',  description: 'Room unit for sale' },
  // Storage
